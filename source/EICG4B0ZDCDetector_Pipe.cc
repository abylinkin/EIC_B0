...
if(m_Params->get_int_param("ispipe")==0){
  ...
  G4VSolid *solid1 = new G4Tubs("EICG4B0ZDCSolid1",
          0.,
  ...
  G4VSolid *solidPipeHole = new G4Tubs("EICG4B0ZDCIonPipeSolid",
        0.,
        m_Params->get_double_param("pipe_hole") *cm,
        m_Params->get_double_param("length") * cm,
        0., 360.*degree);
  G4UnionSolid *solid10 = new G4UnionSolid("EICG4B0ZDCSolid10", solid0, solid1);
  G4SubtractionSolid *solidZDC = new G4SubtractionSolid("EICG4B0ZDCSolid", solid10, solidPipeHole, 0, G4ThreeVector(m_Params->get_double_param("pipe_x")*cm, m_Params->get_double_param("pipe_y")*cm, m_Params->get_double_param("pipe_z")*cm));
...
//  m_LogicalVolumesSet.insert(logical);
 //end implement your own here://
  ...
  G4VSolid *solidPipe = new G4Tubs("EICG4B0ZDCIonPipe",
